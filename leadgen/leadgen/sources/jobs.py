...
# --- Title exclusions ------------------------------------------------------
# Company-NAME exclusions (recruiter / auto-dealer / hotel / public-sector /
# generic-stub) live in ``leadgen.filters``; this is the one TITLE filter.
